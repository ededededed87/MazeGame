...
function generateMaze(startingPosition) {
    ...
    else if (!visitedSquares.includes(squareBelowcurrentPosition)) {
    ...
    else if (!visitedSquares.includes(squareLeftOfCurrentPosition)) {
    ...
    else if (!visitedSquares.includes(squareRightOfCurrentPosition)) {
